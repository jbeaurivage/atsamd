...
## [0.17.1](https://github.com/jbeaurivage/atsamd/compare/atsamd-hal-0.17.0...atsamd-hal-0.17.1) - 2024-10-17
...
- Make I2C transactions continuous according to specification ([#741](https://github.com/jbeaurivage/atsamd/pull/741))
- Fix Nightly doc build errors ([#737](https://github.com/jbeaurivage/atsamd/pull/737))
- replace modify with write. prevent losing interrupts in intflag ([#739](https://github.com/jbeaurivage/atsamd/pull/739))
- Remove statement excluding samd51j from i2s peripheral ([#735](https://github.com/jbeaurivage/atsamd/pull/735))
- Add USB clock ([#734](https://github.com/jbeaurivage/atsamd/pull/734))
# Unreleased Changes
